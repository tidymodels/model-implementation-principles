 ...
 * The return value is a tibble with the **same number of rows as the data being predicted**. This implies that `na.action` should not affect the dimensions of the outcome object. The class of the tibble can be overloaded to accommodate specialized methods as long as back data frame functionality is maintained.  [{note}](#dplyr-like)
